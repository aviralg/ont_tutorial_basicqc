...
```{r, echo=FALSE}
knitr::include_graphics("https://nanoporetech.com/themes/custom/nanopore/images/ont-logo.svg?tutorial=basicqc")
```
</div>
...
```{r demultiplex, cache=FALSE, echo=FALSE, eval=FALSE}
barcodes = 0
barcodeUnass = 0
barcodeRange <- c(0,0)
